class ScatterPlot {
    ...
    update() {
        ...
        self.xvalue = d => d.people_2020;
        self.yvalue = d => d.people_2021;
    ...
    render() {
        ...
        circles
            .on('mouseover', (e,d) => {
                d3.select('#tooltip')
                    .style('opacity', 1)
                    //.html(`<div class="tooltip-label">${d.species}</div>(${d.people_2020}, ${d.people_2021})`);
                    .html(`<div class="tooltip-label">${d.deviation_value}</div>(${d.people_2020}, ${d.people_2021})`);
            })
            .on('mousemove', (e) => {
                const padding = 10;
                d3.select('#tooltip')
